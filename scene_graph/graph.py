...
class GraphTripleConv(nn.Module):
  ...
  def __init__(self, input_dim, output_dim=None, hidden_dim=512,
    ...
    # Network g (net1)
    # Input:
    # - Concat(vs, vr, vo): shape => # of relationships x 3Din
    # Layers:
    # - (1) Linear: transform dimensions from 3Din to H -> ReLU
    # - (2) Linear: transform dimensions from H to 2H + DOut -> ReLU
    """
    ...
    # Network h (net2)
    # Pre-process:
    # - Union of Subjects and Objects: shape => O x H
    # - Take the mean over axis 0
    # Input:
    # - Objects set union
    # Layers:
    # - (1) Linear: transform dimensions from H to H -> ReLU
    # - (2) Linear: transform dimensions from H to DOut -> ReLU
    output_dim: 2nd hidden_dim -> out_dim
    """
  ...
  def forward(self, obj_vecs, pred_vecs, edges):
    ...
    # print("O SHOPPING NETWORK: " + str(O))
    ...
    # we first need to expand the indices to have shape (T, Dout)
    """
    add and merge vector values of objects [subjects and objects] together
    """
    ...
    """
    input the pooled objects to network2
    """
